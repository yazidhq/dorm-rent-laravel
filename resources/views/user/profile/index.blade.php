...
<div class="container emp-profile">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="profile-img" style="width: 350px; height: 350px; overflow: hidden; border-radius: 50%;">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                            aria-controls="profile" aria-selected="false">Data Sewa Kamar</a>
                    </li>
                </ul>
            </div>
            <div class="tab-content profile-tab" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p>{{ auth()->user()->alamat == NULL ? '-' : auth()->user()->alamat }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p>{{ auth()->user()->pekerjaan == NULL ? '-' : auth()->user()->pekerjaan }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(Carbon\Carbon::parse($item->tanggal_masuk)->addMonths($item->jangka_sewa)->isPast())
                                        <button class="btn btn-sm btn-danger" disabled>
                                            Penyewaan Telah Berakhir
                                        </button>
                                        @else
                                        <button class="btn btn-sm btn-{{ $item->status == "Belum Dikonfirmasi"
                                            ? "warning" : "success" }}" disabled>
                                            {{ $item->status == "Belum Dikonfirmasi" ? "Sewa Belum Dikonfirmasi" : "Sewa
        ...
        <div class="col-md-2">
            <button class="profile-edit-btn" data-toggle="modal" data-target="#editProfile{{ auth()->user()->id }}">Edit
                Profile</button>
            <div class="modal fade" id="editProfile{{ auth()->user()->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('update-profile') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input hidden type="text" class="form-control" name="role" value="user">
                                <input hidden type="text" class="form-control" name="status" value="Akun Aktif">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control mb-3" name="number"
                                            placeholder="Whatsapp" value="{{ auth()->user()->number }}" required>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control mb-3" name="pekerjaan"
                                            placeholder="Pekerjaan" value="{{ auth()->user()->pekerjaan }}">
                                    </div>
                                    <div class="col-12">
                                        <input type="password" name="password" class="form-control mb-3"
                                            value="{{ substr(auth()->user()->password, 0, 8) }}" required>
                                    </div>
                                    <div class="col-12">
